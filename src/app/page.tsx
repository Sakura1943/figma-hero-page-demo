...
export default function Home() {
  return (
    <div className="w-screen md:h-screen bg-[#ffee62] flex md:flex-row flex-col overflow-hidden">
      <div className="flex flex-col md:px-28 px-10 md:items-start items-center py-14 gap-y-16 md:justify-between h-full flex-wrap">
